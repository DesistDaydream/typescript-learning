...
const result = GenericFunc<string>("hello")
console.log(result)
// 也可以不指定泛型的具体类型，让编译器自动推断
const result2 = GenericFunc("hello")
console.log(result2)
...
const firstElementResult = firstElement([1, 2, 3])
...
const swapResult = swap<string, number>("hello", 123)
...
const createArrayResult = createArray(3, "x")
...
const persion: PersionIF<string, string> = {
  name: "DesistDaydream",
  getName() {
    return this.name
  },
